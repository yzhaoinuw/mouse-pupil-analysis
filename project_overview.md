...
- `checkpoints_exp/` is produced by `training/run_train.py`; package a selected model into `mouse_pupil_analysis/checkpoints/` only as an intentional, reviewed release change.
