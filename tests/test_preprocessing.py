...
def test_model_to_video_length_undoes_uniform_downscale():
    ...
    assert model_to_video_length(10.0, 296, 148) == pytest.approx(20.0)
    assert model_to_video_length(10.0, 148, 296) == pytest.approx(20.0)


def test_model_to_video_length_is_identity_at_model_size():
    assert model_to_video_length(37.0, MODEL_IMAGE_SIZE, MODEL_IMAGE_SIZE) == pytest.approx(37.0)


def test_model_to_video_length_scales_area_not_edge():
    ...
    assert model_to_video_length(10.0, 200, 160) == pytest.approx(expected)
