...
Status: velocity calculation, confidence-heatmap overlays, 1-based source-frame names, unified user-facing outputs, and the selected 90-frame/5-fps main-cadence README demo with dashed rejected estimates are implemented and approved for delivery through `dev` and `main`
